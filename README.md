...
I tested traditional ML models (RF, SVR, XGBoost) and deep learning architectures (LSTM, GRU, CNN-LSTM).
The Bidirectional LSTM achieved the highest statistical fit on IBM daily closing prices (2015–2025).
